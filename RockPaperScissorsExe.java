...
class Game {
    ...
    // Method to get user move with exception handling
        ...
        while (true) {
            try {
                ...
                if (userMove.equals("Rock") || userMove.equals("Paper") || userMove.equals("Scissors")) {
                    ...
                    throw new IllegalArgumentException("Invalid Move!! Please enter only Rock, Paper, or Scissors.");
                }
    ...
    // Method to ask play again with exception handling
        ...
        while (true) {
            try {
                ...
                if (playAgain.equalsIgnoreCase("yes") || playAgain.equalsIgnoreCase("no")) {
                    ...
                    throw new IllegalArgumentException("Invalid Input! Please type only 'yes' or 'no'.");
                }
            } catch (IllegalArgumentException e) {
                System.out.println(e.getMessage());
                System.out.println();
    ...
    public void start() {
        while (true) {
            try {
                ...
                System.out.println("Something went wrong during the game: " + e.getMessage());
                System.out.println("Restarting the round...");
            }
        }
    }
}
